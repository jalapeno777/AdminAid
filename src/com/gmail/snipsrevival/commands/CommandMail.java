...
public class CommandMail implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {	
		...
		if(args.length == 0) {
			...
			if(args[0].equalsIgnoreCase("read") && sender.hasPermission("adminaid.mail.read")) {
				readMail(sender, args);
			}
			else if(args[0].equalsIgnoreCase("remove") && sender.hasPermission("adminaid.mail.remove")) {
				removeSingleMail(sender, args);
			}
			else if(args[0].equalsIgnoreCase("removeall") && sender.hasPermission("adminaid.mail.remove")) {
				removeAllMail(sender, args);
			}
			else if(args[0].equalsIgnoreCase("send") && sender.hasPermission("adminaid.mail.send")) {
				sendMail(sender, args);
			}
			else if(args[0].equalsIgnoreCase("sendall") && sender.hasPermission("adminaid.mail.sendall")) {
				sendAllMail(sender, args);
			}
			else if(args[0].equalsIgnoreCase("sendstaff") && sender.hasPermission("adminaid.mail.sendstaff")) {
